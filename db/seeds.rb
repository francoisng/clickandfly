...
model.each do |model|
  ...
  Airplane.create!(address: location.sample, model: model, category: category.sample, seat_capacity: rand(10..25), range: rand(1100.0..5000).round(3), daily_price: rand(3000..15000), user: users.sample) 
end
